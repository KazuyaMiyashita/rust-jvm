...
fn test() {
    ...
    assert_eq!(class_file, ClassFile {
        ...
        constant_pool: vec![
            ...
            CpInfo::ConstantUtf8Info { tag: 0x01, length: 0x06, bytes: "Person".as_bytes().to_vec() },
            CpInfo::ConstantUtf8Info { tag: 0x01, length: 0x04, bytes: "name".as_bytes().to_vec() },
            CpInfo::ConstantUtf8Info { tag: 0x01, length: 0x12, bytes: "Ljava/lang/String;".as_bytes().to_vec() },
            ...
            CpInfo::ConstantUtf8Info { tag: 0x01, length: 0x03, bytes: "age".as_bytes().to_vec() },
            CpInfo::ConstantUtf8Info { tag: 0x01, length: 0x01, bytes: "I".as_bytes().to_vec() },
            CpInfo::ConstantUtf8Info { tag: 0x01, length: 0x16, bytes: "(Ljava/lang/String;I)V".as_bytes().to_vec() },
            ...
            CpInfo::ConstantUtf8Info { tag: 0x01, length: 0x0b, bytes: "Person.java".as_bytes().to_vec() },
        ],
        access_flags: 0x20,
        this_class: 0x08,
        super_class: 0x02,
